...
'''
    ...
    Add your modular input logic to file input_module_test_port_input.py
'''
class ModInputtest_port_input(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputtest_port_input, self).__init__("ta_webtools", "test_port_input", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputtest_port_input, self).get_scheme()
        scheme.title = ("Test Port Input")
...
if __name__ == "__main__":
    exitcode = ModInputtest_port_input().run(sys.argv)
    sys.exit(exitcode)
