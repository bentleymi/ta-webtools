...
class BaseModInput(smi.Script):
    ...
    # HTTP request helper
    def send_http_request(self, url, method, user=None, passwd=None, parameters=None, payload=None, headers=None, cookies=None, verify=True,
        ...
        :return: Response
        """
        return self.rest_helper.send_http_request(url=url, method=method, user=user, passwd=passwd, parameters=parameters, payload=payload,
